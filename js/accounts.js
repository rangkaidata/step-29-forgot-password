...
function Accounts(){
	...
	function formulir(){
		html='<form autocomplete="off">'
			...
			+'<li><label for="account_opening">Opening</label>: '
	...
	function bacaData(isi){
		...
		for (var z=0;z<data.length;z++){
			html+='<tr>'
				...
				+'<td>'+data[z].account_debit+'</td>'
				+'<td>'+data[z].account_credit+'</td>'
				+'<tr>';
		}
		html+='</table>';
	...
	function exportData(){
		...
		loadXHR(url+"read_export.php",obj,exportShow5); 	
