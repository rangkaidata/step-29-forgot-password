...
function downloadMsg(namaFile,isiData){
	var html='Silakan klik tombol berikut untuk mengunduh file backup.<br>'
		+'<button type="button" onclick="downloadFile(\''+namaFile+'\',\''+encodeURIComponent(isiData)+'\')">Download</button>';
